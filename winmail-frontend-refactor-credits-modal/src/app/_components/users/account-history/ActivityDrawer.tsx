        ...
        <DrawerBody px={3}>
          <VStack>
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              {' '}
              Resource Type:
              <Text color={'black'}> {activity.resourceType}</Text>
            </Text>
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              {' '}
              ID: <Text color={'black'}> {activity.resourceId}</Text>
            </Text>
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              Action: <Text color={'black'}>{activity.actionType}</Text>
            </Text>
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              Status: <Text color={'black'}>{activity.status}</Text>
            </Text>
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              Created At:
              <Text color={'black'}>
            ...
            <Text w={'100%'} color={'purple.500'} gap={2} display={'flex'}>
              ...
              <Text color={'black'}>
                {' '}
                {dayjs(activity.updatedAt).format('DD MMM YYYY')}
              </Text>
            </Text>
          </VStack>
        </DrawerBody>
