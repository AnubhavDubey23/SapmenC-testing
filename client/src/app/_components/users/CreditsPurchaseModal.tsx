...
export const CreditsPurchaseModal = ({ 
  ...
  const { purchaseCredits, loading: purchaseCreditsLoading } = usePurchaseCredits();
  const { incrementCredits } = useCredits();
  const { initializePayment } = useRazorpay();
  const toast = useToast();

  const creditPriceMap = {
    2000: 200, 4000: 400, 6000: 600, 8000: 800, 10000: 1000,
    15000: 1500, 20000: 2000, 25000: 2500, 30000: 3000, 35000: 3500,
    40000: 4000, 45000: 4500,
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="6xl" isCentered>
      ...
      <ModalContent borderRadius="20px" p={8}>
        <ModalHeader color="#3F2DA5" fontSize="xx-large">Purchase Credits</ModalHeader>
        <ModalCloseButton />
        ...
        <ModalBody>
          <Flex direction={{ base: 'column', lg: 'row' }} gap={8}>
            ...
            <Box flex={1}>
              ...
              <Grid templateColumns="repeat(auto-fit, minmax(100px, auto))" gap={3}>
                {creditOptions.map((amount) => {
                  const isLegacy = amount < 15000
                  const isSelected = selectedCredits === amount
                  const imageSrc = isLegacy ? "/payment/credits.svg" : "/payment/credits_2.0.svg"
                  ...
                  return (
                    <GridItem key={amount}>
                      <Box
                        ...
                        boxShadow={isSelected ? "0 0 0 3px rgba(63, 45, 165, 0.1)" : "0px 4px 6px -4px rgba(0, 0, 0, 0.1), 0px 10px 15px -3px rgba(0, 0, 0, 0.1)"}
                        _hover={{
                          borderColor: "#3F2DA5",
                          cursor: "pointer",
            ...
            <Flex direction="column" align="center" justify="center" position="relative" >
              <Divider orientation="vertical" height="100%" borderColor="gray.300" />
              <Box
                position="absolute"
                bg="white"
                px={4}
              ...
              >
                <Text fontSize="xl" fontWeight="bold" color="black">OR</Text>
              </Box>
            </Flex>
            ...
            <Box flex={1} minW="400px">
              ...
              <VStack spacing={6} align="stretch"> 
                <Flex align="center" gap={3}> 
                  <Image src="/payment/secure-payment.svg" alt="Secure" height="20px" /> 
                  <Text fontWeight="bold" fontSize="large" color="gray.600">Secure Payment</Text> 
                  <Flex ml="auto" gap={3}> 
                    <Image src="/payment/visa.svg" alt="Visa" height="25px" /> 
                    <Image src="/payment/mastercard.svg" alt="Mastercard" height="25px" />
                    <Image src="/payment/amex.svg" alt="Amex" height="25px" />
                    <Image src="/payment/rupay.svg" alt="RuPay" height="25px" />
                    <Image src="/payment/maestro.svg" alt="Maestro" height="25px" />
                  </Flex>
                </Flex>
